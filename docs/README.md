...
| [decisions/0001-local-dnssec-validation.md](decisions/0001-local-dnssec-validation.md) | How DNS Daddy will validate DNSSEC locally, and the build consequences |
